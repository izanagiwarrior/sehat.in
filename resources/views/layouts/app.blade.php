...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top text-white text-dark" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="{{route('welcome')}}"><img src="{{asset('img/logo.png')}}" style="object-fit: cover;" alt="..." /></a>
...
<footer class="footer py-4">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 text-lg-start">Copyright &copy; Ximi Store 2021</div>
            <div class="col-lg-4 my-3 my-lg-0">
                <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/storeximi/"><i class="fab fa-instagram"></i></a>
            </div>

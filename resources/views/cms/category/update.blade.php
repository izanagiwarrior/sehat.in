...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Update Category') }} : {{ $data->name }}</h1>
...
<form method="POST" action="{{ route('category.update.process', $data->id) }}" autocomplete="off" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label class="" for="btn-img-upload">{{ __('Existing Category Image') }}</label>
                        <img src="{{asset('storage/' . $data->photo)}}" class="w-100">
                    </div>
                    <div class="form-group">
                        <label class="" for="btn-img-upload">{{ __('Upload New Category Image') }}</label>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Example : Chair, Table, etc..." value="{{ $data->name }}">
                                </div>
                            </div>
                        </div>
                    </div>
